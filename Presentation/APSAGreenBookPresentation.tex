...
\includegraphics{/git_repositories/GreenBook/Paper/figure/ElectPropensity.pdf}
		\end{center}
}
...
\includegraphics{/git_repositories/GreenBook/Paper/figure/PresPropensity.pdf}
		\end{center}
}
...
\frame{
	\frametitle{OLS Regressions}
			\begin{center}		
		{\Large{OLS Regressions with Non-Matched Data}}
\includegraphics[scale=0.60]{/git_repositories/GreenBook/Paper/figure/Table1.pdf}
			\end{center}
}
...
\includegraphics[scale=0.60]{/git_repositories/GreenBook/Paper/figure/Table2.pdf}
		\end{center}
}
...
\frame{
	\frametitle{OLS Regressions}
		\begin{center}
{\LARGE{OLS Regressions with Presidential Party ID Matched Data}}
\includegraphics[scale=0.60]{/git_repositories/GreenBook/Paper/figure/Table3.pdf}		
		\end{center}
}


\frame{
	\frametitle{Bayesian Regressions}
		\begin{center}
{\Large{Bayesian Normal Linear Regression Estimation of Coefficient Effects for Non-Matched Data}}
\includegraphics{git_repositories/GreenBook/Paper/figure/Table4.pdf}
		\end{center}
}
...
\frame{
	\frametitle{Bayesian Regressions}
		\begin{center}
{\Large{Bayesian Normal Linear Regression estimation of Coefficient Effects for Matched Data}}
\includegraphics{git_repositories/GreenBook/Paper/figure/Table5.pdf}
		\end{center}
}
\end{document}