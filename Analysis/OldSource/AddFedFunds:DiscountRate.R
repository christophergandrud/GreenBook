...
# Load data
IMFDiscount <- read.csv("/Users/christophergandrud/Desktop/FRED_Raw_June_2012/FRED_IMFDiscountRate.csv")
OldDiscount <- read.csv("/Users/christophergandrud/Desktop/FRED_Raw_June_2012/FRED_DiscountRate.csv")
