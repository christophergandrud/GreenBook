...
If you are only interested in replicating the analysis, you can download the {\bf{R}} workspace image created while compiling this PDF file. This {\tt{.RData}} file can be downloaded at:
