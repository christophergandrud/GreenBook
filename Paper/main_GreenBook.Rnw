...
\begin{figure}[t]
    \caption{Simulated Interactions between President Party ID Election Period, as well as President Party ID and  Congressional Party Control}
    \label{InterPlot}
    \begin{center}
