...
<<BasicModelandPlots, warning=FALSE, echo=FALSE, message=FALSE, results='hide', fig.height=4, out.width='0.95\\linewidth'>>=
    library(devtools)
    ...
    source_url(AnalysisURL, echo=TRUE)
...
<< NLTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    # Non-matched models with ls
    
    apsrtable(NL1, NL2, NL3, NL4, NL5, NL6, NL7, digits = 1, order = , Sweave = TRUE, stars = "default")
