...
<<PartisanError, warning=FALSE, echo=FALSE, fig.width=7, fig.height=4, out.width='0.8\\linewidth'>>=
    ...
    cpi.data$GlobalModel <- as.factor(cpi.data$GlobalModel)    
...
<< NLTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    ModelNamesA <- c("A1", "A2", "A3", "A4", "A5", "A6", "A7", "A8", "A9", "A10")
    ...
    apsrtable(NL1, NL2, NL3, NL4, NL5, NL6, NL7, NL8, NL9, NL10,
              digits = 1, order = , 
              Sweave = TRUE, 
              stars = "default", 
...
<< ELTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    ModelNamesB <- c("B1", "B2", "B3", "B4", "B5", "B6", "B7", "B8", "B9", "B10")
    ...
    # Table of non-matched models with ls
    apsrtable(EL1, EL2, EL3, EL4, EL5, EL6, EL7, EL8, EL9, EL10,
              digits = 1, 
              Sweave = TRUE, 
              stars = "default", 
...
<< PLTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    ModelNamesC <- c("C1", "C2", "C3", "C4", "C5", "C6", "C7", "C8", "C9", "C10")
    ...
    # Table of non-matched models with ls
    apsrtable(PL1, PL2, PL3, PL4, PL5, PL6, PL7, PL8, PL9, PL10,
              digits = 1, 
              Sweave = TRUE, 
              stars = "default", 
