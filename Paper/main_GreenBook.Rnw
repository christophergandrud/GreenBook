...
In this section we try to understand trends in Fed inflation forecast errors by first discussing theories from the the political economy literature that provide alternative explanations of why forecasts seem to have a partisan bias.
