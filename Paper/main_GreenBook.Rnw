...
This model does not require that forecasters be conscious of their bias, but simply for it to work its way subtly into forecasts, particularly in the subjective aspect of the ``consensus forecast" put forth in the Green Book. Further, because this bias would not need to be conscious, they might not notice their unintentional but systematic error (as mistakes could occur for any number of economic reasons that they have been trained to consider) and so never correct it in future estimates.
...
We also removed quarters from the sample where forecasters would not have known who the president would be because they followed an election. For estimates made two quarters beforehand this meant removing the 2 quarters following each presidential election. Results from these constricted data sets are fairly similar to those from the full data set. \todo{think about}
...
<<ExpectValueParty, warning=FALSE, echo=FALSE, message=FALSE, cache=TRUE, results='hide', fig.width=6, fig.height=4, out.width='0.75\\linewidth'>>=
...
<<InterPlot, warning=FALSE, echo=FALSE, message=FALSE, results='hide', fig.width=7, fig.height=4, out.width='0.95\\linewidth'>>=
...
<< NLTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    CoefNamesA <- c("Intercept", "Recession", "Debt/GDP", "Expenditure/GDP", "Output Gap", "Discount Rate Change", "Qtr. to Election", "Election Period", "Pres. Party ID", "Senate Dem/Rep", "House Dem/Rep", "FRB/GlobalModel", "Pres*Election Period", "Burns", "Greenspan", "Martin", "Miller", "Volcker", "Pres*House", "Pres*Senate", "House*Senate", "Pres*House*Senate") 
...
<< ELTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    CoefNamesB <- c("Intercept", "Debt/GDP", "Expenditure/GDP", "Output Gap", "Discount Rate Change", "Qtr. to Election", "Election Period", "Pres. Party ID", "Senate Dem/Rep", "House Dem/Rep", "FRB/GlobalModel", "Pres*Election Period", "Pres*House", "Pres*Senate", "House*Senate", "Pres*House*Senate") 
...
<< PLTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    CoefNamesC <- c("Intercept", "Recession", "Debt/GDP", "Expenditure/GDP", "Output Gap", "Discount Rate Change", "Qtr. to Election", "Election Period", "Pres. Party ID", "Senate Dem/Rep", "House Dem/Rep", "FRB/GlobalModel", "Pres*Election Period", "Pres*House", "Pres*Senate", "House*Senate", "Pres*House*Senate") 
...
<<GraphPartisanErrorUnemploy, warning=FALSE, message=FALSE, error=FALSE, echo=FALSE, fig.width=7, fig.height=4, out.width='0.95\\linewidth'>>=
