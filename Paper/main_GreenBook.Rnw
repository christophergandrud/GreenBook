...
<<ExpectValueParty, warning=FALSE, echo=FALSE, message=FALSE, cache=TRUE, results='hide', fig.width=6, fig.height=4, out.width='0.8\\linewidth'>>=
...
Higher rates of unemployment tend to lead to a negative inflation error. 
...
%%%%%%% Table of non-matched data with OLS parametric model Dropping presidential terms %%%%%%%%

\begin{table}[ht]
    \caption{OLS Estimation of Covariate Effects on 2 Qtr. Inflation Forecast Error, Dropping Presidential Terms}
...
<<NLPresDropTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    # Run subset models
    source_url("https://raw.github.com/christophergandrud/GreenBook/master/Analysis/SubsetPresTerm.R")
    
    # Model names & Coefficient Names -- Use C for all ElectionPeriod mathced models
    ModelNamesP <- c("Nixon 1", "Nixon 2", "Ford", "Carter", "Reagan 1", "Reagan 2", "GHW Bush", "Clinton 1", "Clinton 2", "GW Bush 1", "GW Bush 2")
    CoefNamesP <- c("Intercept", "Recession", "Debt/GDP", "Expenditure/GDP", "Output Gap", "Discount Rate Change", "Unemployment Rate", "Qtr. to Election", "Pres. Party ID", "FRB/GlobalModel", "Qrt. Election2") 

    # Table of non-matched models with ls
    apsrtable(SNixon1, SNixon2, SFord1, SCarter1, SReagan1, SReagan2, SGHWBush1, SClinton1, SClinton2, SGWBush1, SGWBush2,
              digits = 1, 
              Sweave = TRUE, 
              stars = "default", 
