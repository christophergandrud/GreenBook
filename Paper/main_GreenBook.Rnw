...
<< ELTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    # Model names & Coefficient Names -- Use B for all  mathced models
    ModelNamesB <- c("B1", "B2", "B3", "B4", "B5", "B6", "B7", "B8", "B9", "B10", "B11", "B12")
    CoefNamesB <- c("Intercept", "Deficit/GDP", "Expenditure/GDP", "Output Gap", "Discount Rate Change", "Unemployment Rate", "Qtr. to Election", "Election Period", "Pres. Party ID", "Senate Dem/Rep", "House Dem/Rep", "FRB/GlobalModel", "Qrt. Election2", "Pres*Qrt. Election2", "Pres*House", "Pres*Senate", "House*Senate", "Pres*House*Senate") 
    ...
    apsrtable(EL1, EL2, EL3, EL4, EL5, EL6, EL7, EL8, EL9, EL10, EL11, EL12,
              ...
              notes = list(se.note, 
                           stars.note, 
                           "The recession variable is ommitted because there was almost no variation in the matched data set.",
...
<< PLTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    CoefNamesC <- c("Intercept", "Recession", "Deficit/GDP", "Expenditure/GDP", "Output Gap", "Discount Rate Change", "Unemployment Rate", "Qtr. to Election", "Election Period", "Pres. Party ID", "Senate Dem/Rep", "House Dem/Rep", "FRB/GlobalModel", "Qrt. Election2", "Pres*Qrt. Election2", "Pres*House", "Pres*Senate", "House*Senate", "Pres*House*Senate") 
...
Variables <- c("Intercept", "Pres. Party ID", "Recession", "Qtr. to Election", "Deficit/GDP",  "Expenditure/GDP", "Output Gap", "Discount Rate Change", "Unemployment Rate", "Global Model", "sigma2")
...
<<NLPresDropTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    CoefNamesP <- c("Intercept", "Recession", "Deficit/GDP", "Expenditure/GDP", 
