...
<<SaveImage, echo=FALSE, warning=FALSE, message=FALSE>>=

    # Save workspace image.
    # Note: if you are replicating this data set you might not want to run this step, or you might want to change the working directory to something that fits your computer.

    # save.image(file = "/git_repositories/GreenBook/Data/GreenBookWorkspaceImage.RData", safe = FALSE, compress = "bzip2")
...
<< NLTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    ModelNamesA <- c("A1", "A2", "A3", "A4", "A5", "A6", "A7", "B8")
    CoefNamesA <- c("Intercept", "Recession", "Debt/GDP", "Expenditure/GDP", "Output Gap", "Qtr. to Election", "Election Period", "Pres. Party ID", "Senate Dem/Rep", "House Dem/Rep", "Pres Party ID*House", "Pres Party ID*Senate") 

    # Table of non-matched models with ls
    apsrtable(NL1, NL2, NL3, NL4, NL5, NL6, NL7, NL8, 
              digits = 1, order = , 
              Sweave = TRUE, 
              stars = "default", 
...
<< ELTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    ModelNamesB <- c("B1", "B2", "B3", "B4", "B5", "B6", "B7", "B8")
    CoefNamesB <- c("Intercept", "Debt/GDP", "Expenditure/GDP", "Output Gap", "Qtr. to Election", "Election Period", "Pres. Party ID", "Senate Dem/Rep", "House Dem/Rep", "Pres Party ID*House", "Pres Party ID*Senate") 

    # Table of non-matched models with ls
    apsrtable(EL1, EL2, EL3, EL4, EL5, EL6, EL7, EL8, 
              digits = 1, 
              order = , 
              Sweave = TRUE, 
              stars = "default", 
...
<< PLTables, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    ModelNamesC <- c("C1", "C2", "C3", "C4", "C5", "C6", "C7", "C8")
    CoefNamesC <- c("Intercept", "Recession", "Debt/GDP", "Expenditure/GDP", "Output Gap", "Qtr. to Election", "Election Period", "Pres. Party ID", "Senate Dem/Rep", "House Dem/Rep", "Pres Party ID*House", "Pres Party ID*Senate") 

    # Table of non-matched models with ls
    apsrtable(PL1, PL2, PL3, PL4, PL5, PL6, PL7, PL8, 
              digits = 1, 
              order = , 
              Sweave = TRUE, 
              stars = "default", 
