...
\ttfamily\noindent
\hspace*{\fill}\\
\hlstd{}\hlfunctioncall{library}\hlkeyword{(}\hlsymbol{apsrtable}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hspace*{\fill}\\
\hlstd{}\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }Non-matched{\ }models{\ }with{\ }ls}\hspace*{\fill}\\
\hlstd{}\hspace*{\fill}\\
\hlstd{}\hlfunctioncall{apsrtable}\hlkeyword{(}\hlsymbol{NL1}\hlkeyword{,}{\ }\hlsymbol{NL2}\hlkeyword{,}{\ }\hlsymbol{NL3}\hlkeyword{,}{\ }\hlsymbol{NL4}\hlkeyword{,}{\ }\hlsymbol{NL5}\hlkeyword{,}{\ }\hlargument{Sweave}{\ }\hlargument{=}{\ }\hlnumber{TRUE}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\begin{verbatim}
## Error: object 'NL4' not found
\end{verbatim}
\end{kframe}
