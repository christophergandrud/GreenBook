...
\author{Cassandra Grafstr\"{o}m and Christopher Gandrud}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\includegraphics[width=0.95\linewidth]{figure/BasicModelPlots} 
\end{knitrout}
