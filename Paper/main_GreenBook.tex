...
\begin{table}[ht]
    ...
    {\scriptsize
\begin{kframe}
\begin{flushleft}\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: object 'NL13' not found}\end{flushleft}\end{kframe}
...
\begin{table}[ht]
    ...
    {\footnotesize
\begin{kframe}
\begin{flushleft}\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: object 'EL12' not found}\end{flushleft}\end{kframe}
...
\begin{table}[ht]
    ...
    {\footnotesize
\begin{kframe}
\begin{flushleft}\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: object 'PL12' not found}\end{flushleft}\end{kframe}
