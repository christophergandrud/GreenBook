...
\begin{alltt}
\hlcomment{# Load required libraries for all code chunks}
\hlfunctioncall{library}(knitr, ggplot2, gridExtra, devtools, MatchIt, plyr, reshape, reshape2, 
    RCurl, stats, xtable, apsrtable)
\end{alltt}


{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: unused argument(s) (xtable, apsrtable)}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: could not find function "matchit"}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: could not find function "setx"}}
